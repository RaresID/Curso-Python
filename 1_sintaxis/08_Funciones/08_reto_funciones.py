...
radio_usuario= input("Introduce radio: ")

# Convertir la entrada a número decimal
# Escribe aquí tu código
float_radio_usuario = float(radio_usuario)


# Llamar a la función con el radio del usuario
# Escribe aquí tu código
area_usuario = calcular_area_circulo(float_radio_usuario)


print(f"El área de un círculo con radio {float_radio_usuario} es: {area_usuario}")